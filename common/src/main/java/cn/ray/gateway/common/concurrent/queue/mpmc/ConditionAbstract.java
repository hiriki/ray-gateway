...
abstract class ConditionAbstract implements Condition {
     ...
     * @see cn.ray.gateway.common.concurrent.queue.mpmc.Condition#awaitNanos(long)
     */
    @Override
     ...
     * @see cn.ray.gateway.common.concurrent.queue.mpmc.Condition#await()
     */
    @Override
     ...
     * @see cn.ray.gateway.common.concurrent.queue.mpmc.Condition#signal()
     */
    @Override
    public void signal() {
        queueLock.lock();
